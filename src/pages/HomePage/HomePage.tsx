...
function HomePage() {
    ...
    return (
        <div className="flex flex-col items-center justify-center gap-8 w-full h-full -mt-16">
            ...
            <div className="flex flex-row gap-4 w-full items-center justify-center h-16">
                ...
                <button className="btn btn-primary btn-lg h-full w-[20%]">Sign up for a free account</button>
            </div>
            <div className="flex flex-row gap-4 w-full items-center justify-center">
                <p className="text-xl">Already a member?</p>
                <button className="btn btn-accent btn-outline btn-lg">Sign in</button>
            </div>
        </div>
    )
}
